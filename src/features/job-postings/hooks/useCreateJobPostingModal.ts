...
import { useCreateJobPostingMutation } from "./useCreateJobPostingMutation";
import {
...
const defaultValues: CreateJobPostingFormValues = {
  jobTitle: "",
  categoryId: "",
  city: "",
  applicationDeadline: "",
...
export function useCreateJobPostingModal({ onClose }: Params) {
  const [values, setValues] =
    useState<CreateJobPostingFormValues>(defaultValues);
